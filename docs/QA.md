...
The branch implements stabilization and visual changes; production has not been updated. Physical mobile acceptance remains outstanding.

## Automated server checks

Node.js 24.14.0 on macOS 26.6.2. `npm test`: 12 passing tests including two nested complete-game cases.
...
- Deployment with an actual Railway volume, backup configuration, and post-deploy full game/reconnect on desktop and phones.
